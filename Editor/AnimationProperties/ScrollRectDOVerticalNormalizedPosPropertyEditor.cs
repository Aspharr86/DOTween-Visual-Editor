...
namespace DOTweenUtilities
{
    ...
    [CustomEditor(typeof(ScrollRectDOVerticalNormalizedPosProperty), true)]
    public class ScrollRectDOVerticalNormalizedPosPropertyEditor : TweenerAnimationPropertyBaseEditor
    {
