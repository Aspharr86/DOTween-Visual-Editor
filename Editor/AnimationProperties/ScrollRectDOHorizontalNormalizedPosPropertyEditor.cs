...
namespace DOTweenUtilities
{
    ...
    [CustomEditor(typeof(ScrollRectDOHorizontalNormalizedPosProperty), true)]
    public class ScrollRectDOHorizontalNormalizedPosPropertyEditor : TweenerAnimationPropertyBaseEditor
    {
